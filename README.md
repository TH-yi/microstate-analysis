...
```powershell
pca microstate-pipeline across-runs --input-dir storage/pca_microstate_output/individual_run --output-dir storage/pca_microstate_output/across_runs --data-suffix _pca_individual_maps.json --save-suffix _pca_across_runs.json --subjects sub_01 --subjects sub_02 --subjects sub_03 --subjects sub_04 --subjects sub_05 --subjects sub_06 --subjects sub_07 --subjects sub_08 --subjects sub_09 --subjects sub_10 --subjects sub_11 --subjects sub_12 --subjects sub_13 --subjects sub_14 --subjects sub_15 --subjects sub_16 --subjects sub_17 --subjects sub_18 --subjects sub_19 --subjects sub_20 --subjects sub_21 --subjects sub_22 --subjects sub_23 --subjects sub_24 --subjects sub_25 --subjects sub_26 --subjects sub_27 --subjects sub_28 --percentage 0.95 --n-k 6 --n-k-index 4 --n-ch 63 --log-dir storage/log/pca_across_runs --log-prefix pca_across_runs --condition-dict-json '{"idea_generation":["1_idea generation","2_idea generation","3_idea generation"],"idea_evolution":["1_idea evolution","2_idea evolution","3_idea evolution"],"idea_rating":["1_idea rating","2_idea rating","3_idea rating"],"rest":["1_rest","3_rest"]}' 
```
...
```bash
microstate-analysis pca microstate-pipeline across-subjects --input-dir storage/pca_microstate_output/across_runs --output-dir storage/pca_microstate_output/across_subjects --data-suffix _pca_across_runs.json --save-name pca_across_subjects.json --subjects sub_01 --subjects sub_02 --subjects sub_03 --subjects sub_04 --subjects sub_05 --subjects sub_06 --subjects sub_07 --subjects sub_08 --subjects sub_09 --subjects sub_10 --subjects sub_11 --subjects sub_12 --subjects sub_13 --subjects sub_14 --subjects sub_15 --subjects sub_16 --subjects sub_17 --subjects sub_18 --subjects sub_19 --subjects sub_20 --subjects sub_21 --subjects sub_22 --subjects sub_23 --subjects sub_24 --subjects sub_25 --subjects sub_26 --subjects sub_27 --subjects sub_28 --condition-names idea_generation --condition-names idea_evolution --condition-names idea_rating --condition-names rest --percentage 0.95 --n-k 6 --n-ch 63 --log-dir storage/log/pca_across_subjects --log-prefix pca_across_subjects 
```
