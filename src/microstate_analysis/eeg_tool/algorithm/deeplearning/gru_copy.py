...
if __name__ == '__main__':
    ...
    path_save_dir = r'D:\EEGdata\reconstuction_sequences\single_sub_reconstruction\gru\seq_200_0.75_48'

    # path_dir = r'/media/concordia/DA081B82081B5D37/Hongjiang/EEG/sequences'
    # path_save_dir = r'/media/concordia/DA081B82081B5D37/Hongjiang/EEG/results'
